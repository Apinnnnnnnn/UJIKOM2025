...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['login'])) {
  ...
  if ($loginStatus) {
    echo "<script>alert('Anda Berhasil Login'); window.location='../Views/v_dashboard.php';</script>";
    exit;
  } else {
    echo "<script>alert('Username/Email atau Password salah'); window.location='../index.php';</script>";
    exit;
  }
}
