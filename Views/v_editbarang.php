...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
  ...
  $controller->editBarang($id_barang, $nama_barang, $id_suplayer, $jumlah_barang, $harga, $kategori, $tanggal_masuk);
          ...
          <form action="" method="POST">
            ...
            <div>
              ...
              <div class="input-group">
                ...
                <input type="number" name="harga" value="<?php echo $barang['harga'] ?? '' ?>" class="form-control" required>
              </div>
            </div>
            <div class="mb-3">
